    ...
    var NPCs = {
        ...
        VillageGirl: Npc.extend({
            init: function(id) {
                ...
                this.beforeQuestCompleteTalk = [
                    ["오빠, 마을에 쥐가 너무 많아",
                     "Help me please! These mice have been eating all our foods!"],
                    ["쥐 좀 10마리만 잡아줘",
                     "Kill 10 for me and I will award you."],
                ];
                this.afterQuestCompleteTalk = [
                    ...
                    ["미안할 짓을 왜 하는데?",
                     "Why did you do about what you are sorry?"],
                    ["누가 지금 그것때문에 화났데?",
                     "Who said I am angry about that?"],
                    ["변했어..",
                     "You changed.."],
                    ["됐어. 오빠도 다른 남자랑 똑같아.",
                     "Leave me alone. You are just the same as other guys."],
                ];
            }
        }),
        Villager: Npc.extend({
        ...
        Mojojojonpc: Npc.extend({
            init: function(id) {
                ...
                this.beforeQuestCompleteTalk = [
					["천사놈을 골려주기위해",
                     "I have placed snow ladies all over the sky map"],
					["하늘맵 여기저기에다가 설녀를 쫙 깔았어.",
                     "just to make the angel's life impossible."],
					["결국 천사놈이 늘어나는 설녀가 감당이 안 되서",
                     "Eventually, I saw him make it off to the plains of snow"],
					["설원으로 도망갔다더군.",
                     "He couldn't stand so much ladies around him."],
					["하지만 정말 싫구만",
                     "But still, I'm not satisfied."],
					["설녀만 있어도 북적북적한 이 공간에",
                     "This place is overcrowded."],
					["오징어와 윈드가디언이 돌아다니고 있다니",
                     "Not only the wind ladies are here, but also the squid and the wind guardian!"],
					["보기 싫은 저 두 놈을 없애주고 그 두 놈에게서",
                     "Would you please get rid of them for me?"],
					["타이푼과 오징어갑옷을 각각 하나씩 가져와줘",
                     "And bring me a typhoon and a squid armor."],
					["그럼 나의 패배한 악당의 도망가기 실력을 이용해서",
                     "One of each is enough."],
					["너의 이속 스킬을 한 단계 업그레이드 해줄게",
                     "Then, I'll upgrade your Supercat skill to level 2."],
                ];
                this.afterQuestCompleteTalk = [
                    ["고마워.",
                     "Thanks."],
